...
published:
created: 2026-06-24
description: "大家好，我是小林。 2026 年开始，AI Agent 开发的浪潮真正席卷整个互联网行业。 不光是 AI 算法、AI 应用工程师这些「天生 AI」的岗位，面试题越问越深；连后端开发、前端开发、数据开发这些原本跟 AI 隔了一道墙的岗位，面试官也开始或多或少地问起 AI 题了。比如： 「你的项目里有没有用过 LLM？怎么用的？」 「假如让你做一个 Age..."
tags:
  - "clippings"
---
[公众号@小林面试笔记](https://xiaolinnote.com/) AI Agent 大约 13 分钟 约 4025 字
...
📖 专题完整介绍： [Agent 面试专题首页](https://xiaolinnote.com/ai/agent/agent_info.html)
...
📖 专题完整介绍： [RAG 面试专题首页](https://xiaolinnote.com/ai/rag/rag_info.html)
...
📖 专题完整介绍： [LLM 工具调用面试专题首页](https://xiaolinnote.com/ai/tools/tools_info.html)
...
📖 专题完整介绍： [大模型工程面试专题首页](https://xiaolinnote.com/ai/llm/llm_info.html)
