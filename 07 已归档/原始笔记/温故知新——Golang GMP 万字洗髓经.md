...
published:
created: 2026-06-12
description: "0 前言我在 23 年初曾发布过一篇——golang gmp 原理解析，当时刚开始接触 go 底层源码，视野广度和理解深度都有所不足，对一些核心环节的思考和挖掘有所欠缺，对其中某些局部细节又过分拘泥，整体内容质量上还是…"
tags:
  - "clippings"
---
156 人赞同了该文章
...
我在 23 年初曾发布过一篇——golang [gmp](https://zhida.zhihu.com/search?content_id=248981159&content_type=Article&match_order=1&q=gmp&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE0Mjk1MjYsInEiOiJnbXAiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNDg5ODExNTksImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.ztgGWOiyvy5oXfI9m7rzKznI8mwpdT66Fi3v11ggKlE&zhida_source=entity) 原理解析，当时刚开始接触 go 底层源码，视野广度和理解深度都有所不足，对一些核心环节的思考和挖掘有所欠缺，对其中某些局部细节又过分拘泥，整体内容质量上还是有所不足.
...
- `第一章——基础概念` ：简述线程、协程及 [goroutine](https://zhida.zhihu.com/search?content_id=248981159&content_type=Article&match_order=1&q=goroutine&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE0Mjk1MjYsInEiOiJnb3JvdXRpbmUiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNDg5ODExNTksImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.4PkZwqZhMIIVjQxiXzArsETHfRa4L1RM60jzL_qqHzI&zhida_source=entity) 的基础概念，并进一步引出 gmp 架构
...
> 提前做个声明，本文涉及大量对 golang [runtime](https://zhida.zhihu.com/search?content_id=248981159&content_type=Article&match_order=1&q=runtime&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE0Mjk1MjYsInEiOiJydW50aW1lIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjQ4OTgxMTU5LCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.YWmKEtiXsPXD7u3rYbeuWTtHS_bH8RTajehD-OSaL1Y&zhida_source=entity) 标准库源码的阅读环节，其中展示的源码版本统一为 v1.19 版本.  
...
![](https://picx.zhimg.com/v2-1cfc0c1d2445415444e7026433adbdb5_1440w.jpg)
...
golang 的内存管理模块主要继承自 [TCMalloc](https://zhida.zhihu.com/search?content_id=248981159&content_type=Article&match_order=1&q=TCMalloc&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE0Mjk1MjYsInEiOiJUQ01hbGxvYyIsInpoaWRhX3NvdXJjZSI6ImVudGl0eSIsImNvbnRlbnRfaWQiOjI0ODk4MTE1OSwiY29udGVudF90eXBlIjoiQXJ0aWNsZSIsIm1hdGNoX29yZGVyIjoxLCJ6ZF90b2tlbiI6bnVsbH0.5JtaBw91eMZ2x8OR38ASYeDcGAdpLD4192nbZkyaLYg&zhida_source=entity) （Thread-Caching-Malloc）的设计思路，其中由契合 gmp 模型做了因地制宜的适配改造，为每个 p 准备了一份私有的高速缓存——mcache，能够无锁化地完成一部分 p 本地的内存分配操作.
...
在设计 io 模型时，golang 采用了 linux 系统提供的 epoll 多路复用技术，然而为了因为 epoll\_wait 操作而引起 m（thread）粒度的阻塞，golang 专门设计一套 netpoll 机制，使用用户态的 gopark 指令实现阻塞操作，使用非阻塞 epoll\_wait 结合用户态的 goready 指令实现唤醒操作，从而将 io 行为也控制在 g 粒度，很好地契合了 gmp 调度体系.
...
![](https://picx.zhimg.com/v2-3dcd692aa7facbfcf9af47d64e1ead8b_1440w.jpg)
...
发布于 2024-10-13 17:40・中国台湾[豆包让小白也能玩转 AI 漫画图片生成](https://www.doubao.com/chat/?channel=dbweb_zhihu_xxl_pc_cpc_ty_shengt_stcj_dmtp_512&source=dbweb_zhihu_xxl_pc_cpc_ty_shengt_stcj_dmtp_512&keywordid=3734823&ad_platform_id=zhihu_feed_lead&ug_callback_url=https%3A%2F%2Fsugar.zhihu.com%2Fplutus_adreaper_callback%3Fsi%3D0a5b9fd9-41fa-4db7-a04d-ee89efbdea35%26os%3D3%26zid%3D1629%26zaid%3D3744379%26zcid%3D3734823%26cid%3D3734823%26event%3D__EVENTTYPE__%26value%3D__EVENTVALUE__%26ts%3D__TIMESTAMP__%26cts%3D__TS__%26mh%3D__MEMBERHASHID__%26adv%3D784531%26ocg%3D0%26cp%3D0%26ocs%3D0%26aic%3D0%26atp%3D0%26ct%3D0%26ed%3DGiBNJgVzfCMmUW9XFyEvRA8xBGxJICwkOhh0FlwxKw1Gdx87VSAsMi9Cb1QXISFcCiIEeh4yNyw9GGJBRCUlVFZ0DngJcmN3ehFkUwBkfwNZY1YkXSo-fX4DPhIMYMczP351_kDL&cb=https%3A%2F%2Fsugar.zhihu.com%2Fplutus_adreaper_callback%3Fsi%3D0a5b9fd9-41fa-4db7-a04d-ee89efbdea35%26os%3D3%26zid%3D1629%26zaid%3D3744379%26zcid%3D3734823%26cid%3D3734823%26event%3D__EVENTTYPE__%26value%3D__EVENTVALUE__%26ts%3D__TIMESTAMP__%26cts%3D__TS__%26mh%3D__MEMBERHASHID__%26adv%3D784531%26ocg%3D0%26cp%3D0%26ocs%3D0%26aic%3D0%26atp%3D0%26ct%3D0%26ed%3DGiBNJgVzfCMmUW9XFyEvRA8xBGxJICwkOhh0FlwxKw1Gdx87VSAsMi9Cb1QXISFcCiIEeh4yNyw9GGJBRCUlVFZ0DngJcmN3ehFkUwBkfwNZY1YkXSo-fX4DPhIMYMczP351_kDL&ug_semver=v1.0.0&spu=biz%3D0%26ci%3D3734823%26si%3Db406fc6b-5839-4875-ac32-12da65e6cc06%26ts%3D1781256727%26zid%3D1629)

[

豆包让小白也能玩转 AI 漫画图片生成

](https://www.doubao.com/chat/?channel=dbweb_zhihu_xxl_pc_cpc_ty_shengt_stcj_dmtp_512&source=dbweb_zhihu_xxl_pc_cpc_ty_shengt_stcj_dmtp_512&keywordid=3734823&ad_platform_id=zhihu_feed_lead&ug_callback_url=https%3A%2F%2Fsugar.zhihu.com%2Fplutus_adreaper_callback%3Fsi%3D0a5b9fd9-41fa-4db7-a04d-ee89efbdea35%26os%3D3%26zid%3D1629%26zaid%3D3744379%26zcid%3D3734823%26cid%3D3734823%26event%3D__EVENTTYPE__%26value%3D__EVENTVALUE__%26ts%3D__TIMESTAMP__%26cts%3D__TS__%26mh%3D__MEMBERHASHID__%26adv%3D784531%26ocg%3D0%26cp%3D0%26ocs%3D0%26aic%3D0%26atp%3D0%26ct%3D0%26ed%3DGiBNJgVzfCMmUW9XFyEvRA8xBGxJICwkOhh0FlwxKw1Gdx87VSAsMi9Cb1QXISFcCiIEeh4yNyw9GGJBRCUlVFZ0DngJcmN3ehFkUwBkfwNZY1YkXSo-fX4DPhIMYMczP351_kDL&cb=https%3A%2F%2Fsugar.zhihu.com%2Fplutus_adreaper_callback%3Fsi%3D0a5b9fd9-41fa-4db7-a04d-ee89efbdea35%26os%3D3%26zid%3D1629%26zaid%3D3744379%26zcid%3D3734823%26cid%3D3734823%26event%3D__EVENTTYPE__%26value%3D__EVENTVALUE__%26ts%3D__TIMESTAMP__%26cts%3D__TS__%26mh%3D__MEMBERHASHID__%26adv%3D784531%26ocg%3D0%26cp%3D0%26ocs%3D0%26aic%3D0%26atp%3D0%26ct%3D0%26ed%3DGiBNJgVzfCMmUW9XFyEvRA8xBGxJICwkOhh0FlwxKw1Gdx87VSAsMi9Cb1QXISFcCiIEeh4yNyw9GGJBRCUlVFZ0DngJcmN3ehFkUwBkfwNZY1YkXSo-fX4DPhIMYMczP351_kDL&ug_semver=v1.0.0&spu=biz%3D0%26ci%3D3734823%26si%3Db406fc6b-5839-4875-ac32-12da65e6cc06%26ts%3D1781256727%26zid%3D1629)